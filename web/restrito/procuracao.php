    ...
    <table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr valign="top">
        <td width="199" height="75">
          <img src="../img/logo_print.jpg" width="175" height="60" alt="Logo InformSystem">        </td>
        <td width="351" height="75" valign="middle">
          <b>Inform System Servi&ccedil;os de Prote&ccedil;&atilde;o ao Cr&eacute;dito Nacional Ltda.</b>        </td>
      </tr>
    </table>
...
<div class="nimprimir"><p>&nbsp;</p><p>&nbsp;</p></div>
<br class="quebrapagina">
<p align="justify" style="margin-bottom: 0cm;">CART&Oacute;RIO PARA RECONHECIMENTO DE FIRMA:</p>
<?= $r['cartorioreconhecimento'] ?>
<p>&nbsp;</p>
<p align="justify" style="margin-bottom: 0cm;">REFER&Ecirc;NCIAS DO ENDERE&Ccedil;O:</p>
<?= $r['referenciasdoendereco'] ?>
