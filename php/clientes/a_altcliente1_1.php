...
// teclas 63230 a 63240 = safari
    ...
    window.onload = function () {
        ...
        id('pct_pesquisa').onkeypress = function () {
            formataMascara('#99,99', mtel);
        }
...
$comando = "SELECT 
                ...
                a.cpfsocio2, a.emissao_financeiro, a.vendedor, CAST(MID(b.logon,1,6) AS UNSIGNED) as logon, 
                REPLACE(mid(b.logon,7,10),'S','') as senha, a.classe, a.banco_cliente, a.agencia_cliente,
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3" class="subtitulopequeno">
                ...
                <input name="inscricao_estadual" type="text" id="inscricao_estadual" value="<?php echo $matriz['inscricao_estadual']; ?>" size="22" maxlength="14" onFocus="this.className = 'boxover'" onBlur="maiusculo(this);
                        this.className = 'boxnormal'" />digite apenas n&uacute;meros</td>
        </tr>
        <tr>
            <td class="subtitulodireita">CNAE Fiscal</td>
            <td colspan="3" class="subtitulopequeno"><input name="cnae_fiscal" type="text" id="cnae_fiscal" value="<?php echo $matriz['cnae_fiscal']; ?>" size="22" maxlength="7" onFocus="this.className = 'boxover'" onBlur="maiusculo(this);
                    this.className = 'boxnormal'" />digite apenas n&uacute;meros</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" class="subtitulopequeno"><input name="inscricao_estadual_tributario" type="text" id="inscricao_estadual_tributario" value="<?php echo $matriz['inscricao_estadual_tributario']; ?>" size="22" maxlength="14" onFocus="this.className = 'boxover'" onBlur="maiusculo(this);
                    this.className = 'boxnormal'" />digite apenas n&uacute;meros</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" class="subtitulopequeno"><input name="cidade" type="text" id="cidade" value="<?php echo $matriz['cidade']; ?>" size="30" maxlength="30" onFocus="this.className = 'boxover'" onBlur="maiusculo(this);
                    this.className = 'boxnormal'" /></td>
        </tr>
        <tr>
            <td class="subtitulodireita">CEP</td>
            <td colspan="3" class="subtitulopequeno"><input name="cep" type="text" id="cep" onKeyPress="soNumero();
                    formatar('##.###-###', this)" value="<?php echo $matriz['cep']; ?>" size="12" maxlength="10" onFocus="this.className = 'boxover'" onBlur="this.className = 'boxnormal'" /></td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="subtitulopequeno">
                <table border="0" class="subtitulopequeno">
                    ...
                    <tr>
                        ...
                        <td><input name="cpf1" type="text" id="cpf1" OnKeyPress="soNumero();
                                formatar('###.###.###-##', this)" value="<?php echo $matriz['cpfsocio1']; ?>" size="17" maxlength="14" onFocus="this.className = 'boxover'" onBlur="this.className = 'boxnormal'" /></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td colspan="3" valign="top" class="subtitulopequeno">
                    <select name="emitir_nfs">
                        <option value="" <?php
            if ($matriz['emitir_nfs'] == "") {
                echo "selected";
            }
            ?> >Selecione</option>
                        <option value="S" <?php
            if ($matriz['emitir_nfs'] == "S") {
                echo "selected";
            }
            ?> >SIM</option>
                        <option value="N" <?php
            if ($matriz['emitir_nfs'] == "N") {
                echo "selected";
            }
            ?> >N&Atilde;O</option>
                    </select>
