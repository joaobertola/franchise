...
function pesquisaReceita(){
 	d = document.incclient;
    d.action = 'painel.php?pagina1=receita2.php';
	d.submit();
}
...
<table border="0" align="center" width="643">
  ...
  <tr>
    ...
    <td colspan="2" class="subtitulopequeno"><input name="atendente_resp" type="text" id="resp_conferencia" size="65" maxlength="100" onFocus="this.className='boxover'" onBlur="maiusculo(this); this.className='boxnormal'" />
      (*)<font color="#FF0000">&nbsp;Respons&aacute;vel pela Confer&ecirc;ncia </font></td>
  </tr>
  <tr>
    <td class="subtitulodireita">&nbsp;</td>
    <td colspan="2" class="subtitulopequeno"><a href="../php/clientes/documentos/ROTEIRO_DE_CONFERENCIA_ATUALIZADO_12_04_2010.pdf" target="_blank"><span class="botao3d">Roteiro Confer&ecirc;ncia - Clique aqui</span></a> (Confira os contratos e evite inadimpl�ncia)</td>
  </tr> 
  <tr>
    ...
    <?php   
   if (($tipo == "a") or ($tipo == "c")){?>
    <input name="insc" type="text" id="insc" size="22" maxlength="18" onKeyPress="soNumero();" onFocus="this.className='boxover'" onBlur="this.className='boxnormal'; return validadoc_2()" value="<?=$_REQUEST['cnpj_receita']?>"/>
    <?php }else{?>
    <input name="insc" type="text" id="insc" size="22" maxlength="18" onKeyPress="soNumero();" onFocus="this.className='boxover'" onBlur="this.className='boxnormal'; return validadoc()" value="<?=$_REQUEST['cnpj_receita']?>"/>
    <?php }?>    
      (*) digite apenas n&uacute;meros </td>
  </tr>
  
  <?php if ( empty($_REQUEST['ok']) ){
	  	$liberar = "readonly='readonly'";;
  ?>
  <tr>
    <td class="subtitulodireita">&nbsp;</td>
    <td colspan="2" class="subtitulopequeno">
   	<?
		include("receita.php");
		$img = curl_recebe_img("http://www.receita.fazenda.gov.br/scripts/srf/intercepta/captcha.aspx?opt=image","receita.gif","","receita.txt");
	?>
		<img src="receita.gif" /></p>
        <br>
         Digite as Letras:
         <input type="text" name="letra" maxlength="4"/>
		<input type="button" value="Pesquisar" onclick="pesquisaReceita()"/>
   	</td>
  </tr>
  <?php }else{ $liberar = ""; } ?>
  <tr>
    <td class="subtitulodireita">Raz&atilde;o Social</td>
    <td colspan="2" class="subtitulopequeno"><input name="razaosoc" type="text" id="razaosoc" size="65" maxlength="50" onFocus="this.className='boxover'" onBlur="maiusculo(this); this.className='boxnormal'" <?=$liberar?> value="<?=$_REQUEST['razaosocial_receita']?>"/>
      (*)</td>
  </tr>
  <tr>
    <td class="subtitulodireita">Nome Fantasia</td>
    <td colspan="2" class="subtitulopequeno"><input name="nomefantasia" type="text" id="nomefantasia" size="65" maxlength="50" onFocus="this.className='boxover'" onBlur="maiusculo(this); this.className='boxnormal'" <?=$liberar?> value="<?=$_REQUEST['fantasia_receita']?>"/>
      (*)</td>
  </tr>
  ...
  <tr>
    ...
    <td class="subtitulopequeno">
		<table>
		  	<tr>
				<td><input type="text" name="cep" id="cep" onChange="" onKeyPress="return MM_formtCep(event,this,'#####-###');" onFocus="this.className='boxover'" onBlur="this.className='boxnormal'" maxlength="9" <?=$liberar?> value="<?=$_REQUEST['cep_receita']?>"/> (*) Autoformata&ccedil;&atilde;o</td>
  ...
  <tr>
    ...
    <td colspan="2" class="subtitulopequeno"><input type="text" name="logradouro" id="logradouro" size="75" maxlength="200" <?=$liberar?> value="<?=$_REQUEST['endereco_receita']?>"/> 
      (*) </td>
  </tr>
  <tr>
    <td class="subtitulodireita">N&uacute;mero</td>
    <td class="subtitulopequeno" colspan="2">
    <input type="text" name="numero" id="numero" <?=$liberar?> value="<?=$_REQUEST['numero_receita']?>"/> 
    (*) Opcional </td>
  </tr>
  <tr>
    <td class="subtitulodireita">Complemento</td>
    <td colspan="2" class="subtitulopequeno"><input type="text" name="complemento" id="complemento" <?=$liberar?> value="<?=$_REQUEST['compl_receita']?>"/> 
      (*) Opcional </td>
  </tr>
  <tr>
    <td class="subtitulodireita">Bairro</td>
    <td colspan="2" class="subtitulopequeno"><input type="text" name="bairro" id="bairro" <?=$liberar?> value="<?=$_REQUEST['bairro_receita']?>"/> 
      (*)</td>
  </tr>
  <tr>
    <td class="subtitulodireita">Cidade</td>
    <td colspan="2" class="subtitulopequeno"><input type="text" name="localidade" id="localidade" <?=$liberar?> value="<?=$_REQUEST['cidade_receita']?>"/> 
      (*) </td>
  </tr>
  <tr>
