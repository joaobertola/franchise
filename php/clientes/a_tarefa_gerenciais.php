     ...
     <tr>
      ...
      <td colspan="2" class="campoesquerda">
      	<select name="ano_esc" class="boxnormal" style="width:20%">
	        <option value="2014" <?php if($ano_esc == '2014'){?> selected="selected" <?php } ?>>2014</option>
            <option value="2013" <?php if($ano_esc == '2013'){?> selected="selected" <?php } ?>>2013</option>
            <option value="2012" <?php if($ano_esc == '2012'){?> selected="selected" <?php } ?>>2012</option>
            <option value="2011" <?php if($ano_esc == '2011'){?> selected="selected" <?php } ?>>2011</option>
            <option value="2010" <?php if($ano_esc == '2010'){?> selected="selected" <?php } ?>>2010</option>
            <option value="2009" <?php if($ano_esc == '2009'){?> selected="selected" <?php } ?>>2009</option>
        </select>
      </td>
    </tr>
