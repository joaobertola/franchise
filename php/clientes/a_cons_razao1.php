...
if ( ($_SESSION['id'] <> 163) && ($_SESSION['id'] <> 4) && ($_SESSION['id'] <> 5) )
	$frq = " AND a.id_franquia = ".$_SESSION['id'];

$comando = "select a.id_franquia_jr, a.codloja, a.razaosoc, a.insc, a.nomefantasia, a.uf, a.cidade, a.bairro, a.end, a.cep, a.fone, a.fax, a.email,
			a.tx_mens, b.fantasia, date_format(a.dt_cad, '%d/%m/%Y') as data, a.sitcli, d.descsit, a.obs, c.descricao, a.celular,
			a.fone_res, a.socio1, a.socio2, a.cpfsocio1, a.cpfsocio2, a.emissao_financeiro, a.vendedor, a.sit_cobranca, f.descricao, g.nbanco, a.agencia_cliente, a.conta_cliente, a.cpfcnpj_doc, date_format(a.dt_regularizacao, '%d/%m/%Y') AS dt_regularizacao,  a.pendencia_contratual, a.nome_doc, a.tpconta from cs2.cadastro a
			inner join cs2.franquia b on a.id_franquia=b.id
			left outer join cs2.ramoativ c on a.id_ramo=c.id
			inner join cs2.situacao d on a.sitcli=d.codsit
			inner join cs2.logon e on a.codloja=e.codloja
			inner join cs2.classif_cadastro f on a.classe=f.id
			left outer join consulta.banco g on a.banco_cliente=g.banco
			where a.codloja='$codloja' $frq";
$res = mysql_query ($comando, $con);
$matriz = mysql_fetch_array($res);

if  ( mysql_num_rows ($res) == 0 ){
	echo "ESTE CLIENTE NAO PERTENCE A SUA CARTEIRA, OU N�O EXISTE";
	exit;
}
...
<table border="0" align="center" width="643">
  ...
  <tr>
    ...
    <td class="campojustificado"><?php echo $matriz['razaosoc']; ?></td>
  </tr>
  <tr>
