...
// comentado dia 31/01/19 a pedido do Danillo
// include("area_restrita/janela_limite_credito.php");

?>
<form method="post" action="painel.php?pagina1=area_restrita/d_lancamento.php" >
<table width=560 border="0" align="center">
  <tr class="titulo">
    <td colspan="2">CONTA CORRENTE DA <?php echo $nome_franquia; ?><input name="id_frq" id="id_frq" type="hidden" value="<?php echo $id_franquia; ?>" ></td>
  </tr>	
      <tr>
