...
$sql_csv = "select a.numdoc, CAST(MID(b.logon,1,6) AS UNSIGNED) as logon, c.razaosoc, c.nomefantasia, a.valor, DATE_FORMAT(a.vencimento,'%d/%m/%Y') as 								vencimento, a.valorpg, DATE_FORMAT(a.datapg,'%d/%m/%Y') as datapg, a.numboleto, a.origem_pgto
			...
			where CAST(MID(b.logon,1,6) AS UNSIGNED) between '$codigo1' and '$codigo2' $situacao $intervalo
			group by numdoc
