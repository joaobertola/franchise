...
$numdoc 	= $_GET['numdoc']; // codigo da antecipacao
$codloja 	= $_GET['codigo1']; // codgo do cliente

$comando = "SELECT 
                a.numboleto, b.razaosoc, b.nomefantasia, DATE_FORMAT(a.vencimento,'%d/%m/%Y') as venc, a.valor 
            FROM cs2.titulos_antecipacao a
            INNER JOIN cs2.cadastro b ON a.codloja = b.codloja
            WHERE a.contrato='$numdoc'";
...
<body>
    <form name="baixa" method="post" onSubmit="return validaClientes();" action="Franquias/b_dar_baixa_antecipacao.php" >
        <input type="hidden" name="numdoc" value="<?=$_REQUEST['numboleto']?>">
        ...
        <table width="90%" border="0" align="center">
            <tr>
                <td colspan="2" class="titulo">Baixa de T&iacute;tulos - ANTECIPA&Ccedil;&Atilde;O</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="subtitulopequeno"><?php echo $matriz['numboleto']; ?><input name="numdoc" type="hidden" value="<?php echo $matriz['numboleto']; ?>" ></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="subtitulopequeno"><input type="text" name="datapg" size="16" maxlength="10" value="<?php echo $hoje; ?>" onKeyPress="mascara(this,data)" class="boxnormal" onFocus="this.className='boxover'" onBlur="this.className='boxnormal';" >dd/mm/aaaa</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="subtitulopequeno">Juros
                    <input type="text" name="juros" size="16" maxlength="12" onKeydown="FormataValor(this,20,event,2)" style="text-align:right" onFocus="this.className='boxover'" class="boxnormal" onBlur="this.className='boxnormal'" >
                        Desconto 
                    <input type="text" name="desconto" size="16" maxlength="12" onKeydown="FormataValor(this,20,event,2)" style="text-align:right" onFocus="this.className='boxover'" class="boxnormal" onBlur="this.className='boxnormal'" >
                </td>
            </tr>
            <tr>
