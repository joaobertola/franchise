 ...
 * @copyright 
 * @package nfse
 * @name WebService.CancelarLoteRps.php
 */
...
$objetoSoapServer->register('CancelarLoteRps',
		array(
				"modelo" => "xsd:string",
				"codigo" => "xsd:string",
				"cnpj" => "xsd:string",
		...
		array(
				"return"=>"xsd:string"),
		"urn:WebServer.NFsE",
		"urn:WebServer.NFsE#CancelarLoteRps",
		"rpc",
		"encoded",
		"CancelarLoteRps a RPS da Prefeitura de Curitiba:<br />
		 Modelo informar producao ou homologacao<br />
		 CNPJ da empresa prestadora<br />
		 Protocolo da RPS a ser cancelada<br />");
