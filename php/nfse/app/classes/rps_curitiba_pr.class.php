...
class RPS
{
    ...
    */
    ...
    private function __loadDadosEmpresa()
    {
        ...
        $this->InscricaoMunicipalEmpresa = '010106049109';
        $this->InscricaoEstadualEmpresa = 'ISENTO';
        $this->RazaoSocialEmpresa = 'WORLD CLICK DESENVOLVEDORA DE SOFTWARES LTDA';
        $this->NomeFantasiaEmpresa = 'WEB CONTROL EMPRESAS'; 
        $this->AliquotaISSEmpresa =  '5';
        $this->keyPass =  'Wce480808';
