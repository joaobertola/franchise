...
<table align='center' cellspacing='0' cellpadding='0'>
	...
	$strParam = "caption=Gráfico de Soluções: Web Control Empresas;subCaption=$nome_franquia - últimos 12 Meses;yAxisName=;xAxisName=;palette=1;animation=".getAnimationState(). ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
	# Set Chart Parameter
	$FC->setChartParams($strParam);
	# Get average shiping time xml
	grafico_franquia_07($intYear,$selecao,true,false, $FC);
    ...
    <tr>
    <td align="center">
      <iframe src="Grafico_Franquia_07.php" width="100%" height="700" frameborder="0" scrolling="0"></iframe>
    </td>
    </tr>	
