    ...
    <table align='center' cellspacing='0' cellpadding='0'>
        ...
        <tr>
            <td align='center'>
                ...
                $strParam = "caption=Notas Fiscal ( NFS-e );subCaption=$nome_franquia - últimos 12 Meses;yAxisName=;xAxisName=;palette=1;animation=" . getAnimationState() . ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
                # Set Chart Parameter
                $FC->setChartParams($strParam);
                # Get average shiping time xml
                $res = grafico_franquia_novo_20($intYear, $selecao, true, false, $FC);
                $i = 0;
