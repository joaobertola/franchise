        ...
        <tr>
            <td align='center'>
                ...
                if (($idfranquia == '9999999' or $idfranquia == '163' ) or (empty($idfranquia))) {
                    ...
                    $selecao = " c.id_franquia = $idfranquia AND ";
                    $nome_franquia = nome_franquia($idfranquia);
                }
                #Define Charts Parameter
                $strParam = "caption=Gráfico - Torpedo Marketing;subCaption=$nome_franquia;yAxisName=;xAxisName=;palette=1;animation=" . getAnimationState() . ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
                # Set Chart Parameter
                $FC->setChartParams($strParam);
                # Get average shiping time xml
                $res = grafico_torpedoMarketing($intYear, $selecao, true, false, $FC);
                $i = 0;
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        var options = {
                            title: "Gráfico Torpedo Marketing",
                            width: 1700,
                            height: 800,
                            bar: {
                                groupWidth: "95%"
