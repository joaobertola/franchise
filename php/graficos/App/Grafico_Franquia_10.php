    ...
    <table align='center' cellspacing='0' cellpadding='0'>
        ...
        <tr>
            <td align='center'>
                ...
                $strParam = "caption=Gráfico de Soluções: Contábil Solution;subCaption=$nome_franquia - últimos 12 Meses;yAxisName=;xAxisName=;palette=1;animation=" . getAnimationState() . ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
                # Set Chart Parameter
                $FC->setChartParams($strParam);
                # Get average shiping time xml
                $res = grafico_franquia_novo_10($intYear, $selecao, true, false, $FC);
                $i = 0;
        ...
        <?php
        if (($_REQUEST['id_franquia_session'] != '163') and ($_REQUEST['id_franquia_session'] != "")) { ?>
        <tr>
            <td bgcolor="#CCCCCC">&nbsp;</td>
        </tr>
        <tr>
            <td align="center">
                <iframe src="Grafico_Franquia_10.php" width="100%" height="700" frameborder="0" scrolling="0"></iframe>
            </td>
        </tr>
        <tr>
            <td height="100">&nbsp;</td>
