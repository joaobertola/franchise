...
<table align='center' cellspacing='0' cellpadding='0'>
	...
	$strParam = "caption=Localiza Max ;subCaption=$nome_franquia - Últimos 12 Meses;yAxisName=;xAxisName=;palette=1;animation=".getAnimationState(). ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
	# Set Chart Parameter
	$FC->setChartParams($strParam);
	# Get average shiping time xml
	grafico_franquia_02($intYear,$selecao,true,false, $FC);
