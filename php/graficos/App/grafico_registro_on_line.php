...
<table align='center' cellspacing='0' cellpadding='0'>
	...
	$strParam = "caption=Gráfico: Registro on Line Brasil;subCaption=$nome_franquia - Últimos 12 Meses;yAxisName=;xAxisName=;palette=1;animation=".getAnimationState(). ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
	# Set Chart Parameter
