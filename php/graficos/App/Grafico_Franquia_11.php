...
<table align='center' cellspacing='0' cellpadding='0'>
	...
	$strParam = "caption=Gráfico : VIRTUAL FLEX ;subCaption=$nome_franquia;yAxisName=;xAxisName=;palette=1;animation=".getAnimationState(). ";showValues=1;formatNumberScale=5;numberSuffix=; labelDisplay=ROTATE;numDivLines=5;slantLabels=1";
	# Set Chart Parameter
	$FC->setChartParams($strParam);
	# Get average shiping time xml
	grafico_virtualflex($intYear,$selecao,true,false, $FC);
	$res = grafico_virtualflex_novo($intYear, $selecao, true, false, $FC);
                $i = 0;
        ...
        <tr>
        <td align="center">
          <iframe src="Grafico_Franquia_11.php" width="100%" height="700" frameborder="0" scrolling="0"></iframe>
        </td>
        </tr>	
