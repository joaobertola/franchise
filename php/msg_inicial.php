...
<script language="javascript">
	...
	//window.open('http://webcontrolempresas.com.br/franquias/mensagem/popup_web_geral.php', 'popup', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,copyhistory=no,width='+<?=$largura?>+',height='+<?=$altura?>+',left='+280+', top='+100+',screenX='+0+',screenY='+0+'');

 	window.location.href="painel.php?pagina1=clientes/a_controle_visitas0.php&mc=<?=$meta_mes_contrato?>&tf=<?=$total_contrato_mes_fechado?>&ft=<?=$total_falta?>";
