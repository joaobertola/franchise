...
?>
<body>
<form method="post" action="painel.php?pagina1=ranking/c_fatmedia.php">
<table width="70%" border="0" align="center">
  <tr>
    <td colspan="2" class="titulo">RANKING DE FATURA M&Eacute;DIA </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="campoesquerda"><select name="mes" size="1" class="formulariopequeno" >
