<?php
	...
	# M�dulo:  Remessa Franquia - Banco Itau
	# Finalidade: Gerar o arquivo de cr�dito a serem enviados ao Banco ITAU para os franqueados
	...
	$Registro .= colocazeros('21201',12);             // 059 a 070 - N�mero da conta do cedente
	$Registro .= ' ';                                 // 071 a 071 - BRANCOS
	$Registro .= '8';                                 // 072 a 072 - D�gito verificador da ag�ncia / conta
	...
	$Registro .= '12275138000182';                    // 019 a 032 - Empresa Numero Inscri��o - Debitada
