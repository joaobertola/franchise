...
$sql = "SELECT
			 ...
			 b.login, b.senha, date_format(b.data_criacao,'%d/%m/%Y') AS data_criacao,  b.situacao AS situacao2,
		CASE  b.login_master
...
if($_REQUEST['codigo']){
	$_sql = "SELECT c.codloja
				...
				WHERE MID(l.logon,1,LOCATE('S', l.logon) - 1) = '{$_REQUEST['codigo']}'";
...
if($total == "0"){
	echo "<div align='center'><b><p>Não foi encontrado nenhum Usuário CONTABIL-SOLUTION !</b></div>";
	echo "<div align='center'><b><p><a href='painel.php?pagina1=area_restrita/web_contabil_extrato_usuarios.php'><b>Retorna</b></a></b></div>";
	exit;
}			
?>
...
<tr><td colspan="7" align="center" class="titulo">Listagem de Usuário(s) CONTABIL-SOLUTION</td></tr>
<tr bgcolor="#FF9900">
...
<tr bgcolor="<?=$cor?>">
    ...
    <td>
    <?php if($rs['situacao2'] == "A"){ $desc_ativo = "I";} ?>
    <?php if($rs['situacao2'] == "I"){ $desc_ativo = "A";} ?>     
    <?=$rs['ativo']?></td>    
</tr>
<?php } ?>
</table>
...
<tr>
	<td width="10%"><a href="painel.php?pagina1=area_restrita/web_contabil_extrato_usuarios.php"><b>Retorna</b></a></td>    <td width="90%" align="right">Total de <b><?=$total?></b> Usuário(s) CONTABIL-SOLUTION</td>
</tr>
</table>
<p>