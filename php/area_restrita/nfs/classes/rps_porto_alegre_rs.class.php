...
class RPS
{
    ...
    */
    ...
    private $SubjectName = 'E=nfse@portoalegre.rs.gov.br,  CN=Equipe  de  Desenvolvimento NFS-e,,  O=Secretaria  Municipal  da  Fazenda  (Sefaz),  L=Porto Alegre,  S=Rio Grande do Sul, C=BR';
...
SQLQUERY;
    ...
    private function __assinarRPS( $returned_content  )
    {
        ...
        try
        {
            ...
            $EnviarLoteRpsEnvio = $dom->getElementsByTagName ( "GerarNfseEnvio" )->item ( 0 );
