 ...
 * @copyright 
 * @package nfse
 * @name WebService.ConsultarSituacaoLoteRps.php
 */
...
$objetoSoapServer->register('ConsultarSituacaoLoteRps',
		array(
				"modelo" => "xsd:string",
				"codigo" => "xsd:string",
				"cnpj" => "xsd:string",
		...
		array(
				"return"=>"xsd:string"),
		"urn:WebServer.NFsE",
		"urn:WebServer.NFsE#ConsultarSituacaoLoteRps",
		"rpc",
		"encoded",
		"Consultar s situação do lote da RPS da Prefeitura de Curitiba:<br />
