...
class PHPMailer {
    ...
    public function EncodeQ ($str, $position = 'text') {
        ...
        switch (strtolower($position)) {
            case 'phrase':
                $encoded = preg_match("/([^A-Za-z0-9!*+\/ -])/e", "'='.sprintf('%02X', ord('\\1'))", $encoded);
                break;
            case 'comment':
                $encoded = preg_match("/([\(\)\"])/e", "'='.sprintf('%02X', ord('\\1'))", $encoded);
            case 'text':
            default:
                /* Replace every high ascii, control =, ? and _ characters */
                $encoded = preg_match('/([\000-\011\013\014\016-\037\075\077\137\177-\377])/e',
