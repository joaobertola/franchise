...
<form name="form1" method="post" action="painel.php?pagina1=area_restrita/web_contabil_listagem_usuarios.php">
<table width=90% border="0" align="center" cellpadding="1" cellspacing="1">
  <tr class="titulo">
    <td colspan="2" align="center" height="40">EXTRATO DE CONTRATOS CONTABIL-SOLUTION</td>
  </tr>
  ...
  <tr>
    ...
    <td class="campoesquerda">
        ...
        <input type="radio" name="ordenacao" value="b.data_criacao" />Data de Ativa&ccedil;&atilde;o&nbsp;&nbsp; 
        <?php if ($tipo == "a"){ ?>
        <input type="radio" name="ordenacao" value="b.login_master" />Master&nbsp;&nbsp;
        <input type="radio" name="ordenacao" value="b.situacao" />Ativo
        <?php } ?>
    </td>
  </tr>
  ...
  <tr>
   <td height="40">&nbsp;</td>
   <td><input type="submit" name="pesq1" value="    Pesquisar    " /></td>
    </tr>
</table>
</form>