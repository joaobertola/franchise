...
switch ($tp_rel) {
    ...
    case '1':
        ...
        $sql = "SELECT a.nomefantasia, a.codloja FROM cs2.cadastro a
                ...
                WHERE mid(b.logon,1,LOCATE('S',a.logon)-1) = " . $_REQUEST['cliente'];
...
?>
    ...
    case '3':
        ...
        SELECT 
                ...
                e.nome, mid(l.logon,1,LOCATE('S',a.logon)-1) as idFranquia_Codloja
        ...
        case '4':
            ...
            $sql = "SELECT
                    ...
                    ( SELECT mid(logon,1,LOCATE('S',a.logon)-1) FROM cs2.logon WHERE codloja = c.codloja LIMIT 1) AS logon,
