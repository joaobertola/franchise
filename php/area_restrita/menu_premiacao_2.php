	...
	<table width="70%" align="center">
									...
									<tfoot>
										<tr>
											<td align="center" colspan="3">
				                                ...
				                                <input type="button" value="  Gravar Registrosxx  " onClick="Grava_Registros()"/>
                                                <input type="button" name="pesquisa" value="Pesquisar" onClick="Grava_Registros()"/>
											</td>
										</tr>
									</tfoot>
								</table>
		...
		<tr>
            <td colspan="2">
				...
				<form name="form_rel" method="post" action="relatorio_premiacao.php">
