...
$sql = "
        ...
        FROM base_inform.cadastro_imagem ci
        INNER JOIN cs2.funcionario f
        ON ci.id_funcionario = f.id
        INNER JOIN cs2.funcao fun
        ON fun.id = f.id_funcao
        WHERE ci.data_consultoria BETWEEN '$strDataInicio' AND '$strDataFim'
        AND f.ativo = '$ativo'
        AND IF('$id_funcionario' != 0, f.id = '$id_funcionario' , 0=0)
        AND ci.consultoria_realizada = 1
        GROUP BY ci.id_funcionario;";
//echo $sql;
//die;
    ...
    <div class="imprimir">
        ...
        <div class="page-break">
            ...
            <table width='100%' border='1' cellpadding='0' cellspacing='0' class='' style="margin-top: 5px;">
                <tr>
                    <td colspan="2" class="titulo">Relatório de Atendimento Externo</td>
                </tr>
                <tr>
                    <td class="corpoTabela" align="right">Total Atendimentos&nbsp;</td>
                    <td class="corpoTabela"><?php echo $arrItens['qtd']?></td>
                </tr>
                <tr>
                    <td class="corpoTabela" align="right">Atendimentos x Valor&nbsp;</td>
                    <td class="corpoTabela"><?php echo $arrItens['qtd'] .' x R$' . number_format($fator,2,',','.');?></td>
                </tr>
                <tr>
                    <td class="corpoTabela" align="right">Total à Receber&nbsp;</td>
                    <td class="corpoTabela"><?php echo 'R$ ' . number_format($arrItens['qtd'] * $fator,2,',','.');?></td>
                </tr>
