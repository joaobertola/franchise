                ...
                while ($registro = mysql_fetch_array($qry_sql)) {
                    ...
                    <tr>
                        <td>
                            ...
                            if ($xarq == '') {
                                echo "<img src='area_restrita/d_copia_documentos_ver.php?id=" . $registro['id'] . " width='100%' height='100%'>";
                            } else {
                                if ($tipo_arq == '.JPG') {
                                    ...
                                    echo "<input  name='endereco_foto[]' value='http://contrato.webcontrolempresas.com.br/inform/$xarq'>";
