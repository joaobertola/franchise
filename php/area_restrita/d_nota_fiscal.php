...
<table width=70% align="center">
  <tr>
    <td colspan="2" align="center" class="titulo">
    	SOLICITA&Ccedil;&Atilde;O DE USO
        <br>
        NFe - NFCe - Cupom Fiscal - NFSe - CTe - MDFe
	</td>
  </tr>
  <tr>
...
if ($go=='ingressar') {
	...
	if ($linha == 0)
	{
		print"<script>alert(\"Cliente não existe ou não pertence à sua franquía!\");history.back();</script>";
	}
	else 
	{
		...
		echo "<meta http-equiv=\"refresh\" content=\"0; url= painel.php?pagina1=area_restrita/d_nota_fiscal2.php&codloja=$codloja&logon=$logon&razaosoc=$razaosoc\";>";
	}
}
?>