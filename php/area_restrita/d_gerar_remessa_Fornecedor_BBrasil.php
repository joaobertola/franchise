<?php
	...
	$Registro .= colocaespacos('INFORM SYSTEM TECNOLOGIA EM IN',30);  // 073 a 102 - Nome do cedente
	...
	$Registro .= '2';                                  // 018 a 018 - Tipo de inscri��o do cedente
	$Registro .= colocazeros('06866893000139',14);     // 019 a 032 - N�mero de inscri��o do cedente
	$Registro .= '0009003400126       ';               // 033 a 052 - C�digo do conv�nio no banco
	$Registro .= '03051';                              // 053 a 057 - C�digo da ag�ncia do cedente
	$Registro .= '1';                                  // 058 a 058 - D�gito da ag�ncia do cedente
	$Registro .= '000000014236';                       // 059 a 700 - N�mero da conta do cedente
	$Registro .= '0';                                  // 071 a 071 - D�gito da conta do cedente
    ...
    $sql = "SELECT  DISTINCT(a.codloja) codloja, mid(b.razaosoc,1,30) razaosoc, b.banco_cliente, b.agencia_cliente, 
					...
					'$tarifa_bancaria' as vr_repasse, b.tpconta 
	...
	echo "
		  ...
		  Arquivo:	<a href=https://www.webcontrolempresas.com.br/download/".$arquivo.">".$arq."</a>";
