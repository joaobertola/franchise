...
<table width=70% align="center">
  <tr>
    <td colspan="2" align="center" class="titulo">VISUALIZAR FATURAS DE CLIENTES </td>
  </tr>
  <tr>
...
if ($go=='ingressar') {
	...
	else 
	{
		...
		echo "<meta http-equiv=\"refresh\" content=\"0; url= painel.php?pagina1=franqueado_jr/ver_faturas.php&codloja=$codloja&logon=$logon&razaosoc=$razaosoc\";>";
	}
}
?>