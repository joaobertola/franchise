...
$titulo = "REGISTRO DE OCORR&Ecirc;NCIAS"; // T�tulo da Tela
$thanks_msg = "Ocorr�ncia enviada com sucesso!"; // Mensagem que aparecer� quando a mensagem for enviada com sucesso
$error_msg = "N�o foi possivel enviar a ocorr�ncia. Tente novamente."; // Mensagem de erro ao enviar a mensagem
$smyles = "1"; // Mostrar Smyles para postagem (1 para sim / 0 para n�o)
$credits = "<font size=\"1\" face=\"Verdana\">Este sistema � para uso exclusivo das franquias da <b>Web Control Empresas Tecnolog�a em Informa��es Ltda.</b></font>"; // Mensagem principal da index
