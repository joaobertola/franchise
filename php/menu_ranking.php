...
?>
  ...
  <tr>
    <td align="center"><?php echo $i++; ?></td>
    <td><a href="painel.php?pagina1=clientes/a_download.php" name="link1" id="link1" onMouseOver="MM_showMenu(window.mm_menu_0703115929_0,118,2,null,'link1')" onMouseOut="MM_startTimeout();"><font color="#0033FF"><b>Documentos diversos</b></font></a></td>
  </tr>
  <?php
  ...
  <tr>
    <td align="center"><?php echo $i++; ?></td>
    <td><a href="painel.php?pagina1=ranking/c_ranksemanal.php" onmouseover="return showStatus('Menu Franquias');" onmouseout="return showStatus('');"><font color="#0033FF"><blink><b>Ranking Semanal de Vendas</b></blink></font></a></td>
  </tr>
