...
<body onLoad="if(ieBlink){setInterval('doBlink()',450)}">
	...
	<tr>
		<td align="center"><?php echo $i++; ?></td>
		<td><a href="painel.php?pagina1=clientes/a_formconsulta.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
				<font color="#0033FF"><b>Visualizar cad. e tabela de clientes</b></font>
			</a></td>
	</tr>
	<tr>
		<td align="center"><?php echo $i++; ?></td>
	...
	<tr>
		<td align="center"><?php echo $i++; ?></td>
		<td><a href="painel.php?pagina1=ocorrencias/a_ocorrencia.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
				<font color="red"><b>Registro de Atendimentos</b></font>
			</a></td>
	</tr>
	<?php if ($id_franquia != 1205) { ?>
		<tr>
			<td align="center" class="center"><?php echo $i++; ?></td>
			<td><a href="painel.php?pagina1=clientes/a_ordem_atendimento.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
					<font color="red"><b>Ordens de Atendimento</b></font>
				</a></td>
		</tr>
		<tr>
			<td align="center" class="center"><?php echo $i++; ?></td>
	...
	<?php if ($id_franquia != '01') {  ?>
		...
		<tr>
			<td align="center"><?php echo $i++; ?></td>
			<td><a href="painel.php?pagina1=Franquias/b_boleto.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
					<font color="blue"><b>Boletos - Segunda Via</b></font>
				</a></td>
		</tr>
		...
		<tr>
			<td align="center"><?php echo $i++; ?></td>
			<td><a href="painel.php?pagina1=area_restrita/d_equipamentos0.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
					<font color="#BA55D3"><b>Controle Produtos/Equipamentos
				</a></b></td>
		</tr>
		...
		<?php if ($id_franquia != 1205) { ?>
			...
			<tr>
				<td align="center"><?php echo $i++; ?></td>
				<td><a href="painel.php?pagina1=graficos/i_graficos.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
						<font color="#FF00FF"><b>Gráfico de Desempenho</b></font>
					</a></td>
			</tr>
			<tr>
				<td align="center"><?php echo $i++; ?></td>
			...
			<tr>
				<td align="center"><?php echo $i++; ?></td>
				<td><a href="painel.php?pagina1=virtualflex/v_relatorio.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
						<font color="blue"><b>Relatório Usuários Virtual Flex</b></font>
					</a></td>
			</tr>
			<tr>
				<td align="center"><?php echo $i++; ?></td>
				<td><a href="painel.php?pagina1=area_restrita/virtual_flex_busca_excluir_dominio.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
						<font color="red"><b>Excluir Informações Virtual - Flex</b></font>
					</a></td>
			</tr>
			<tr>
				<td align="center"><?php echo $i++; ?></td>
				<td><a href="painel.php?pagina1=area_restrita/web_control_eliminar_informacoes_busca_cliente.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
						<font color="red"><b>Excluir Informações WebControl</b></font>
					</a></td>
			</tr>
			<tr>
				<td align="center"><?php echo $i++; ?></td>
				<td><a href="painel.php?pagina1=Franquias/logomarca_buscar_cliente.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
						<font color="#009966"><b>Inserir Logomarca do Cliente</b></font>
					</a></td>
			</tr>
		<?php }
	...
	<tr>
		<td align="center"><?php echo $i++; ?></td>
		<td><a href="painel.php?pagina1=area_restrita/d_nota_fiscal.php" onMouseOver="return showStatus('Menu Franquias');" onMouseOut="return showStatus('');">
				<font color="#0000FF"><b>Liberar NFe/NFCe/CF/NFSe/CTe/MDFe</b></font>
			</a></td>
	</tr>
	<?php
	if ($id_franquia == 4 or $id_franquia == 46 or $id_franquia == 163 or $id_franquia == 1204) {
